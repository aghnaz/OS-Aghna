...
<head>
  ...
  <link href="<?=base_url()?>assets/css/db.css" rel="stylesheet" />
</head>
...
<body class="">
  <div class="wrapper ">
    ...
    -->
      <div class="logo">
         <img src="<?=base_url();?>assets/img/hausa.png" alt="IMG" width="200" height="80" style="margin:3% 5% 5% 10%;">
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav-item dashboard">
            <a class="nav-link" href="<?=base_url('index.php/user/dashboard')?>">
              <i class="material-icons">dashboard</i>
              <p>Dashboard</p>
            </a>
          </li>
          <li class="nav-item toko">
            <a class="nav-link" href="<?=base_url('index.php/minum/toko')?>">
              <i class="material-icons">bookmark</i>
              <p>Toko</p>
            </a>
          </li>
          <?php if($this->session->userdata('level')== "admin"):?>
          <li class="nav-item minuman">
            <a class="nav-link" href="<?=base_url('index.php/minum')?>">
          ...
          <li class="nav-item history">
            <a class="nav-link" href="<?=base_url('index.php/pesanan')?>">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo" style="font-size:40px"><?=$judul?></a>
          </div>
