...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="<?=base_url();?>assets/img/hausa-logo.png"/>
<!--===============================================================================================-->
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					...
					<img src="<?=base_url();?>assets/img/hausa.png" alt="IMG" style="margin-top:25%;">
				</div>

				<form class="login100-form validate-form" action="<?=base_url('index.php/user/proses_login')?>" method="post">
            ...
            <input name="login" class="login100-form-btn" value="Masuk" type="submit">
					</div>
					...
					<div class="text-center p-t-12" style="margin-top: 5%">
						<a class="txt2" href="<?=base_url('index.php/user/register')?>">
							Create your Account
